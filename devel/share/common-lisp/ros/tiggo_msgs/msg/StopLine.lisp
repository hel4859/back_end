...
(cl:defmethod cl:initialize-instance :after ((m <StopLine>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'StopLine)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name tiggo_msgs-msg:<StopLine> is deprecated: use tiggo_msgs-msg:StopLine instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <StopLine>))
...
(cl:defmethod valid-val ((m <StopLine>))
...
(cl:defmethod angle-val ((m <StopLine>))
...
(cl:defmethod distance-val ((m <StopLine>))
