...
(cl:defmethod cl:initialize-instance :after ((m <Heading>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Heading)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name tiggo_msgs-msg:<Heading> is deprecated: use tiggo_msgs-msg:Heading instead.")))
...
(cl:defmethod status-val ((m <Heading>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader tiggo_msgs-msg:status-val is deprecated.  Use tiggo_msgs-msg:status instead.")
  (status m))
...
(cl:defmethod std_dev-val ((m <Heading>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader tiggo_msgs-msg:std_dev-val is deprecated.  Use tiggo_msgs-msg:std_dev instead.")
  (std_dev m))
