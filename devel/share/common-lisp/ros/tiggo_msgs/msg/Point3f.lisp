...
(cl:defmethod cl:initialize-instance :after ((m <Point3f>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Point3f)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name tiggo_msgs-msg:<Point3f> is deprecated: use tiggo_msgs-msg:Point3f instead.")))
...
(cl:defmethod z-val ((m <Point3f>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader tiggo_msgs-msg:z-val is deprecated.  Use tiggo_msgs-msg:z instead.")
  (z m))
