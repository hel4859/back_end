...
(cl:defmethod cl:initialize-instance :after ((m <Intersection>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Intersection)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name tiggo_msgs-msg:<Intersection> is deprecated: use tiggo_msgs-msg:Intersection instead.")))

(cl:ensure-generic-function 'state-val :lambda-list '(m))
(cl:defmethod state-val ((m <Intersection>))
...
(cl:defmethod stop-val ((m <Intersection>))
...
(cl:defmethod steer-val ((m <Intersection>))
