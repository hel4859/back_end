...
struct MD5Sum< ::tiggo_msgs::MapTarget_<ContainerAllocator> >
{
  ...
  {
    return "ad9d476107420454fe60afcbe71d1a35";
  }

  static const char* value(const ::tiggo_msgs::MapTarget_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xad9d476107420454ULL;
  static const uint64_t static_value2 = 0xfe60afcbe71d1a35ULL;
};
