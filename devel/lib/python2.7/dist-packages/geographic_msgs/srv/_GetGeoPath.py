...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_struct_6d.pack(_x.start.latitude, _x.start.longitude, _x.start.altitude, _x.goal.latitude, _x.goal.longitude, _x.goal.altitude))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.start.latitude, _x.start.longitude, _x.start.altitude, _x.goal.latitude, _x.goal.longitude, _x.goal.altitude,) = _struct_6d.unpack(str[start:end])
      return self
