...
"""autogenerated by genpy from tiggo_msgs/Cloud_sorted.msg. Do not edit."""
import sys
...
class Cloud_sorted(genpy.Message):
  _md5sum = "0234296d09c3f21b2e75c1f058ddf30b"
  _type = "tiggo_msgs/Cloud_sorted"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """sensor_msgs/PointCloud2[] cloud_s
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(Cloud_sorted, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.cloud_s is None:
        self.cloud_s = []
    else:
      self.cloud_s = []
  ...
  def serialize(self, buff):
    ...
    """
    try:
      length = len(self.cloud_s)
      buff.write(_struct_I.pack(length))
      for val1 in self.cloud_s:
        _v1 = val1.header
