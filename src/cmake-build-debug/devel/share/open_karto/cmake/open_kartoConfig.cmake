...
if("TRUE" STREQUAL "TRUE")
  set(open_karto_SOURCE_PREFIX /home/hl/google/src/open_karto-indigo-devel)
  set(open_karto_DEVEL_PREFIX /home/hl/google/src/cmake-build-debug/devel)
...
if(NOT "/home/hl/google/src/open_karto-indigo-devel/include;/usr/include " STREQUAL " ")
  set(open_karto_INCLUDE_DIRS "")
  set(_include_dirs "/home/hl/google/src/open_karto-indigo-devel/include;/usr/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'open_karto' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/hl/google/src/open_karto-indigo-devel/${idir}'.  Ask the maintainer 'Michael Ferguson <mferguson@fetchrobotics.com>' to fix it.")
    endif()
