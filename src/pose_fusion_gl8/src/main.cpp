...
void state_callback(const gl8_msgs::VehicleIMUConstPtr &imu_in,
                    const gl8_msgs::VehicleSpeedFeedBackConstPtr &vel_in)
{
    if (!have_inited_gps){
...
//void update_callback(const sensor_msgs::NavSatFixConstPtr &gps_in,
//                     const gl8_msgs::GPTRA_MSGConstPtr &attitude_in,
//                     const gl8_msgs::GPGGA_MSGConstPtr &raw_in)
void update_callback(const sensor_msgs::NavSatFixConstPtr &gps_in,
                     const gl8_msgs::GPTRA_MSGConstPtr &attitude_in)
{
    if (!have_inited_gps){
